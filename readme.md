...
**3DTeethSeg: 3D-Intraoralscan Segmentierung**
...
- [Roboflow](https://roboflow.com/)
  ...
  - [Train an RF-DETR Model](https://rfdetr.roboflow.com/latest/learn/train/)
...
.   |   |   ├── 00OMSZGW_lower_elev0_azim0.png
    ...
    |   ├── test/
    |   |   ├── _annotations.coco.json
    |   |   ├── 0AAQ6BO3_lower_elev0_azim0.png
    |   |   └── ...
    |   └── valid/
    |       ├── _annotations.coco.json
    |       ├── 00OMSZGW_upper_elev0_azim0.png
    |       └── ...
    └── Teeth3DS+/
        └── raw/
            ├── lower/
...
### Launching tensorboard from cmd line

```
tensorboard --logdir "output/rf_detr_train"
```

### Launching fiftyone from cmd line
...
see [Issues and Workarounds](doc/issues.md) for details.
...
- [3DTeethSeg’22: 3D Teeth Scan Segmentation and Labeling Challenge](https://arxiv.org/abs/2305.18277)
...
- [ToothGroupNetwork](https://arxiv.org/abs/2305.18277)
